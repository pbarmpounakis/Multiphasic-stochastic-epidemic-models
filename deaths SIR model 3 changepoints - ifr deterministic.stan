...
real<lower=0,upper=100> e[2]; //extra time for the changepoint number 2, 3, 4, 5, 6
...
Rt[t]=R0*exp(-inv_logit(5* (t-T1))*inv_logit(5* (T2-t))*effect[1]-inv_logit(5* (t-T2))*inv_logit(5* (T3-t))*effect[2]-inv_logit(5* (t-T3))*effect[3]);
}
