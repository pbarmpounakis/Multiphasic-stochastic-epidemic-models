...
real<lower=0,upper=100> e[4]; //extra time for the changepoint number 2, 3, 4, 5, 6
...
Rt[t]=R0*exp(-inv_logit(5* (t-T1))*inv_logit(5* (T2-t))*effect[1]-inv_logit(5* (t-T2))*inv_logit(5* (T3-t))*effect[2]-inv_logit(5* (t-T3))*inv_logit(5* (T4-t))*effect[3]-inv_logit(5*(t-T4))*inv_logit(5*(T5-t))*effect[4]-inv_logit(5*(t-T5))*effect[5]);
}
